...
secrets. Nothing here is ours: it is another project's signed release, chosen because it is small
and because its signature was made on the public-good Sigstore instance, which is the same
instance our own releases sign against.
...
## Two traps these fixtures exist to pin
