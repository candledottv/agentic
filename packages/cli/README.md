...
and a copy of the vault is sealed to the passphrase envelope by default (from CLI 0.11.0, not yet
released) unless it goes to a recognised local disk or removable drive, so that one account never holds
