...
- `packages/sdk` (not yet populated, coming in a later task): the TypeScript SDK.
- `packages/mcp` (not yet populated, coming in a later task): the MCP server that wraps the SDK for MCP-compatible agent clients.
